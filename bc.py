...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        scale = 0.25*block.expansion
        self.hyper1_1 = self.hyper_structure1(64, int(256*scale))
        self.hyper2_1 = self.hyper_structure2(int(256*scale),int(512*scale))
        self.hyper3_1 = self.hyper_structure2(int(512*scale),int(1024*scale))
        self.hyper4_1 = self.hyper_structure2(int(1024*scale),int(2048*scale))

        self.hyper2_2 = self.hyper_structure2(int(256*scale),int(512*scale))
        self.hyper3_2 = self.hyper_structure2(int(512*scale),int(1024*scale))
        self.hyper4_2 = self.hyper_structure2(int(1024*scale),int(2048*scale))

        self.hyper3_3 = self.hyper_structure2(int(512*scale),int(1024*scale))
        self.hyper4_3 = self.hyper_structure2(int(1024*scale),int(2048*scale))

        self.hyper4_4 = self.hyper_structure2(int(1024*scale),int(2048*scale))
